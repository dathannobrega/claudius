...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Claudius configuration options"},
    ...
    {TR_HOTKEY_TITLE, "Claudius hotkey configuration"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "The extra Claudius assets could not be loaded.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "The savegame you're trying to load is for a more recent version of Claudius.\nPlease update Claudius to the most recent version." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Unable to save the game" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "It was not possible to save the game.\nIt may be because the folder where Caesar 3 keeps the savegames requires administrator access.\nPlease either change the Caesar 3 folder to a place which doesn't require administrator access or run Claudius as administrator (not recommended)." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Please check claudius-log.txt in your Claudius directory for details."},
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Please check claudius-log.txt in your Claudius directory for details."},
    ...
    {TR_MP_LOBBY_TITLE, "Multiplayer Lobby"},
    {TR_MP_LOBBY_PLAYERS, "Players"},
    {TR_MP_LOBBY_STATUS, "Status"},
    {TR_MP_LOBBY_PING, "Ping"},
    {TR_MP_LOBBY_READY, "Ready"},
    {TR_MP_LOBBY_NOT_READY, "Not Ready"},
    {TR_MP_LOBBY_IN_GAME, "In Game"},
    {TR_MP_LOBBY_DISCONNECTED, "Disconnected"},
    {TR_MP_LOBBY_BUTTON_READY, "Ready"},
    {TR_MP_LOBBY_BUTTON_NOT_READY, "Cancel Ready"},
    {TR_MP_LOBBY_BUTTON_START, "Start Game"},
    {TR_MP_LOBBY_BUTTON_LEAVE, "Leave"},
    {TR_MP_LOBBY_WAITING_HOST, "Waiting for host to start..."},
    {TR_MP_LOBBY_NOT_ALL_READY, "Not all players are ready"},
    {TR_MP_CONNECT_TITLE, "Multiplayer"},
    {TR_MP_CONNECT_ADDRESS, "Host Address:"},
    {TR_MP_CONNECT_BUTTON_CONNECT, "Connect"},
    {TR_MP_CONNECT_BUTTON_BACK, "Back"},
    {TR_MP_CONNECT_LAN_SERVERS, "LAN Servers"},
    {TR_MP_CONNECT_NO_SERVERS, "No servers found"},
    {TR_MP_CONNECT_PLAYERS, "players"},
    {TR_MP_CONNECT_CONNECTING, "Connecting..."},
    {TR_MP_STATUS_TITLE, "Multiplayer Status"},
    {TR_MP_STATUS_CONNECTION, "Connection:"},
    {TR_MP_STATUS_SYNC, "Sync:"},
    {TR_MP_STATUS_TICK, "Tick:"},
    {TR_MP_STATUS_PLAYERS_ONLINE, "Players Online"},
    {TR_MP_STATUS_QUALITY_GOOD, "Good"},
    {TR_MP_STATUS_QUALITY_DEGRADED, "Degraded"},
    {TR_MP_STATUS_QUALITY_POOR, "Poor"},
    {TR_MP_STATUS_QUALITY_CRITICAL, "Critical"},
    {TR_MP_STATUS_QUALITY_UNKNOWN, "Unknown"},
    {TR_MP_STATUS_SYNCED, "Synced"},
    {TR_MP_STATUS_DESYNCED, "Desynced"},
    {TR_MP_STATUS_BUTTON_RESYNC, "Resync"},
    ...
    {TR_MP_P2P_TRADE_TITLE, "Trade with "},
    {TR_MP_P2P_TRADE_CREATE_ROUTE, "Establish Trade Route"},
    {TR_MP_P2P_TRADE_DELETE_ROUTE, "Delete Route"},
    {TR_MP_P2P_TRADE_ENABLE_ROUTE, "Enable Route"},
    {TR_MP_P2P_TRADE_DISABLE_ROUTE, "Disable Route"},
    {TR_MP_P2P_TRADE_STATUS, "Route Status: "},
    {TR_MP_P2P_TRADE_EXPORTS, "You Export (Sell):"},
    {TR_MP_P2P_TRADE_IMPORTS, "You Import (Buy):"},
    {TR_MP_P2P_TRADE_NO_ROUTE, "No trade route established"},
    {TR_MP_P2P_TRADE_CITY_OFFLINE, "City is offline"},
    {TR_MP_P2P_TRADE_THEIR_EXPORTS, "They Export:"},
    {TR_MP_P2P_TRADE_THEIR_IMPORTS, "They Import:"},
    {TR_MP_P2P_TRADE_LIMIT, "Limit: "},
    {TR_MP_P2P_TRADE_UNLIMITED, "No limit"},
    {TR_MP_P2P_TRADE_ROUTE_FULL, "Max routes reached"},
    ...
    {TR_MP_CONNECT_STATUS_RESUME_RECONNECT, "Resume: reconnect"},
    {TR_MP_CONNECT_STATUS_LOBBY_OPEN, "Lobby open"},
    {TR_MP_CONNECT_STATUS_GAME_RECONNECT, "Game: reconnect"},
    {TR_MP_CONNECT_STATUS_GAME_LATE_JOIN, "Game: late join"},
    {TR_MP_CONNECT_STATUS_GAME_CLOSED, "Game: closed"},
    {TR_MP_CONNECT_STATUS_GAME_OPEN, "Game: open"},
    {TR_MP_CONNECT_TIMEOUT, "Connection timed out"},
    {TR_MP_CONNECT_REJECTED, "Connection rejected"},
    {TR_MP_CONNECT_REJECT_VERSION_MISMATCH, "Version mismatch"},
    {TR_MP_CONNECT_REJECT_SESSION_FULL, "Session full"},
    {TR_MP_CONNECT_REJECT_GAME_IN_PROGRESS, "Game in progress"},
    {TR_MP_CONNECT_REJECT_NAME_TAKEN, "Name already in use"},
    {TR_MP_CONNECT_REJECT_BANNED, "Access blocked"},
    {TR_MP_CONNECT_REJECT_NO_RESERVED_SLOTS, "No reserved slots"},
    {TR_MP_CONNECT_REJECT_LATE_JOIN_BUSY, "Late join busy"},
    {TR_MP_CONNECT_REJECT_RECONNECT_REQUIRED, "Reconnect required"},
    {TR_MP_CONNECT_REJECT_SLOT_NOT_FOUND, "Slot not found"},
    {TR_MP_CONNECT_REJECT_WORLD_MISMATCH, "World mismatch"},
    {TR_MP_CONNECT_REJECT_RESUME_GENERATION_MISMATCH, "Resume out of date"},
    {TR_MP_CONNECT_REJECT_INTERNAL_ERROR, "Host internal error"},
    {TR_MP_LOBBY_AWAITING_RECONNECT, "Awaiting Reconnect"},
    {TR_MP_STATUS_LOCAL, "Local"},
    {TR_MP_STATUS_AWAITING, "Awaiting"},
    {TR_MP_RESUME_UNKNOWN, "Unknown"},
    {TR_MP_RESUME_SAVE_LABEL, "Save: "},
#endif
};
