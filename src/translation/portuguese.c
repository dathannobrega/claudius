...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_CONFIG_TITLE, "Opções de Configurações do Claudius"},
    ...
    {TR_HOTKEY_TITLE, "Configurações de teclas de atalho do Claudius"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "Os assets extra do Claudius não foram carregados.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "O jogo salvo que você está tentando abrir é de uma versão mais recente de Claudius.\nPor favor atualize o Claudius para a versão mais recente." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Por favor, confira claudius-log.txt na sua pasta Claudius para mais informações." },
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Por favor, confira claudius-log.txt no seu diretório do Claudius para detalhes."},
    ...
    {TR_CONFIG_NOT_ACCEPTING_MARKETS, "Mercados não aceitam nada quando construídos" },
    {TR_CONFIG_DRAW_WEATHER, "Ativar clima dinâmico"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_HUT_ALT, "Cabana nativa alternativa"},
    {TR_BUILDING_NATIVE_HUT_ALT, "Cabana nativa alternativa"},
    {TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, "Armazéns e celeiros podem ser construídos sobre estradas"},
    {TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING, "Destacar edifício selecionado"},
    {TR_CHEAT_UNLOCK_LEGIONS, "Legiões permitidas: 20"},
    {TR_BUILDING_FORT_STANDARD_ELEPHANTS, "\"Os Elefantes\""},
    {TR_BUILDING_FORT_STANDARD_THUNDER_BOLTS, "\"Os Relâmpagos\""},
    {TR_BUILDING_FORT_STANDARD_BULLS, "\"Os Touros\""},
    {TR_BUILDING_FORT_STANDARD_CENTAURS, "\"Os Centauros\""},
    {TR_BUILDING_FORT_STANDARD_OCTOPI, "\"Os Polvos\""},
    {TR_BUILDING_FORT_STANDARD_BEARS, "\"Os Ursos\""},
    {TR_BUILDING_FORT_STANDARD_SCORPIONS, "\"Os Escorpiões\""},
    {TR_BUILDING_FORT_STANDARD_CAMELS, "\"Os Camelos\""},
    {TR_BUILDING_FORT_STANDARD_DOLPHINS, "\"Os Golfinhos\""},
    {TR_BUILDING_FORT_STANDARD_SEA_GOATS, "\"Os Capricórnios\""},
    {TR_WINDOW_BUILDING_DISTRIBUTION_MAINTAINING, "Mantendo"},
    {TR_CONFIG_MAX_AUTOSAVE_SLOTS, "Número máximo de slots de autosaves anuais:"},
    {TR_TOOLTIP_PERSONAL_SAVINGS, "Tuas reservas pessoais!"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_DECORATION, "Decoração"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_MONUMENT, "Monumento"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_WATCHTOWER, "Atalaia"},
    {TR_BUILDING_NATIVE_DECORATION, "Decoração Nativa"},
    {TR_BUILDING_NATIVE_MONUMENT, "Monumento Nativo"},
    {TR_BUILDING_NATIVE_WATCHTOWER, "Atalaia Nativa"},
    {TR_BUILDING_NATIVE_DECORATION_DESC, "Erguida por artesãos locais, esta estrutura decorativa é altamente apreciada tanto por nativos quanto por romanos.  Apear de carecer de um certo refinamento, muitos cidadãos a consideram instigante."},
    {TR_BUILDING_NATIVE_MONUMENT_DESC, "Esta estrutura magnífica zela sobre estas terras desde os tempos imemoriais. Alguns a consideram prova de que, com engenhosidade e trabalho duro, o povo local consegue alcançar feitos grandiosos, apesar de seu conhecimento inferior de engenharia. Outros, mais céticos, especulam que este pode ser, talvez, um milagre ofertado pelos deuses, ou remanescentes de uma civilização antiga e extremamente avançada."},
    {TR_BUILDING_NATIVE_WATCHTOWER_DESC,"Do topo destas estruturas, os nativos observam cada movimento na nossa cidade, em busca de nossos pontos fracos. A menos que ensinemos aos locais sobre os benefícios da civilização romana, os sentinelas destas torres impedirão qualquer tentativa de expansão sobre esta área."},
    {TR_BUILDING_INFO_CARAVANSERAI_MONTHLY_CONSUMPTION, "Consumo mensal de comida:"},
    {TR_CONFIG_CARAVANS_MOVE_OFF_ROAD, "Caravanas e carroças de bois não priorizam estradas"},
    {TR_TOOLTIP_BUILDING_DISTRIBUTION_MAINTAINING, "Proibir qualquer um, exceto guildas de carroceiros, de mover ou retirar a mercadoria."},
    {TR_CONFIG_STORAGE_STEP_4, "Usar múltiplos de 4 para as quantidades em celeiros, armazéns ou guildas de carroceiros"},
    {TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT, "Ordem original dos itens da barra superior"},
    {TR_TOOLTIP_DEPOT_MOVED, "Movendo mercadoria:"},
    {TR_TOOLTIP_DEPOT_ORDER_TO, "para"},
    {TR_TOOLTIP_RIGHT_CLICK_TO_DECREASE, "Clicar com botão direito para diminuir"},
    {TR_TOOLTIP_POPULATION_GOAL, "Objetivo populacional: "},
    {TR_CONFIG_PATRICIAN_DEVOLUTION_FIX, "Moradias de Patrícios mantêm a integridade quando regridem"},
    {TR_CONDITION_TEXT_TIME_LEFT_UNTIL_DEFEAT, "Tempo até a derrota:"},
    {TR_CONDITION_TEXT_TIME_LEFT_UNTIL_VICTORY, "Tempo até a vitória:"},
    {TR_ACTION_TYPE_CHANGE_TERRAIN, "Adicionar/remover terreno"},
    {TR_PARAMETER_TERRAIN, "Terreno"},
    {TR_PARAMETER_ADD, "Adicionar"},
    {TR_PARAMETER_TERRAIN_TREE, "Árvore"},
    {TR_PARAMETER_TERRAIN_ROCK, "Rocha"},
    {TR_PARAMETER_TERRAIN_WATER, "Água"},
    {TR_PARAMETER_TERRAIN_MEADOW, "Terra Fértil"},
    {TR_PARAMETER_TERRAIN_SHRUB, "Arbusto"},
    {TR_CHEAT_DISABLE_INVASIONS, "Desativar invasões"},
    {TR_CHEAT_DISABLE_LEGIONS_CONSUMPTION, "Desativar consumo de alimentos por soldados"},
    {TR_TOOLTIP_BUTTON_ACCEPT_NATIVES, "Permitir que comerciantes nativos retirem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_NATIVES, "Não permitir que comerciantes nativos retirem daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_CAESAR, "Permitir que solicitações de Caesar retirem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_CAESAR, "Não permitir que solicitações de Caesar retirem daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_ALL, "Permitir que qualquer um retire daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_ALL, "Proibir que qualquer um retire daqui"},
    {TR_TOOLTIP_OVERLAY_PROBLEMS_NO_ROAD_ACCESS, "Sem acesso a estrada"},
    {TR_WARNING_NO_WAREHOUSE_TOWER_ROAD_ACCESS, "Conecte a estrada com a entrada do armazém"},
    {TR_BUILDING_FORT_MENU, "Forte"},
    {TR_PARAMETER_VALUE_BUILDING_MENU_FORTS, "Todos os fortes"},
    {TR_EMPIRE_SIDE_BAR_SORT, "Organizar por:"},
    {TR_EMPIRE_SIDE_BAR_FILTER, "Filtrar por:"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_NAME, "Nome"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_EXPORT, "Cota de Exportação"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_IMPORT, "Cota de Importação"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_ROUTE_COST, "Custo da Rota"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_PROFIT, "Lucro"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE, "Mercadoria"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_SELL, "Mercadoria (Vendida)"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_BUY, "Mercadoria (Comprada)"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_OPEN, "Rotas Abertas"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_CLOSED, "Rotas Fechadas"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_LAND, "Rotas Terrestres"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_SEA, "Rotas Marítimas"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_NONE, "Sem Filtro"},
    {TR_TOOLTIP_CHANGE_SIDEBAR_WIDTH, "Mudar largura da barra lateral"},
    {TR_TOOLTIP_ASCENDING_ORDER, "Ordem Ascendente"},
    {TR_TOOLTIP_DESCENDING_ORDER, "Ordem Decrescente"},
    {TR_CHEAT_CHANGE_WEATHER, "Clima alterado"},
    {TR_CONFIG_DEFAULT_GAME_SPEED, "Velocidade padrão do jogo:"},
    {TR_CONFIG_CATEGORY_GENERAL, "Geral"},
    {TR_CONFIG_CATEGORY_UI_MAP, "Rolagem e Mapa"},
    {TR_CONFIG_CATEGORY_UI_BUILDING, "Construção"},
    {TR_CONFIG_CATEGORY_UI_CITY, "Visão da Cidade"},
    {TR_CONFIG_CATEGORY_UI_WEATHER, "Clima"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_STORAGE, "Armazenamento e Mercados"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_ROADS, "Estradas"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_ROADBLOCKS, "Bloqueios de Estradas"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_HOUSING, "Moradias"},
    {TR_EDITOR_CUSTOM_VARIABLES_TEXT_DISPLAY, "Texto Exibido"},
    {TR_EDITOR_CUSTOM_VARIABLES_IS_VISIBLE, "Visível"},
    {TR_ACTION_TYPE_CHANGE_CUSTOM_VARIABLE_VISIBILITY, "Alterar visibilidade da variável personalizada"},
    {TR_CONFIG_SHOW_CUSTOM_VARIABLES, "Mostrar variáveis personalizadas na visão da cidade"},
    {TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED, "Habilitar 'Buscar' enquanto uma mercadoria estiver sendo estocada"},
    {TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES, "Pavimentar estradas junto a celeiros"},
    {TR_CONFIG_UI_ANIMATE_TRADE_ROUTES, "Animar rotas comerciais"},
    {TR_HOTKEY_NEXT_TRACK, "Próxima música aleatória"},
    {TR_CONFIG_MOVE_LEGION_SOUND_SWAP, "Som alternativo de movimentação de legião"},
    {TR_BUILDING_INFO_REPAIR_BUILDING, "Reconstruir edifício"},
    {TR_WARNING_REPAIR_IMPOSSIBLE, "Não é possível reconstruir este edifício"},
    {TR_WARNING_REPAIR_BURNING, "Não é possível reconstruir enquanto o edifício está pegando fogo"},
    {TR_BUILDING_INFO_BUILDING_BURNING, "Edifício pegando fogo"},
    {TR_BUILDING_LAND_REPAIR, "Reconstruir área"},
    {TR_BUILDING_LAND_CLEAR, "Limpar área"},
    {TR_CONFIRM_REPAIR_BUILDINGS, "Reconstruir todos os edifícios na área para "},
    {TR_CONFIRM_REPAIR_BUILDINGS_TITLE, "Reconstruir edifícios"},
    {TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS, "Habilitar ordens avançadas da Guilda de Carroceiros"},
    {TR_BUILDING_INFO_INSTRUCTIONS, "instruções"},
    {TR_BUILDING_INFO_ACTIVE_STORAGE_BUILDINGS, "Locais de estocagem aceitando"},
    {TR_BUILDING_INFO_OTHER_STORAGE_BUILDINGS, "Outros locais de estocagem"},
    {TR_TOOLTIP_GOTO_STORAGE_INSTRUCTIONS, "Abrir instruções de estocagem do edifício"},
    {TR_BUILDING_INFO_CART_DEPOT_TOOLTIP_STYLE, "Nível de dica de ferramenta:"},
    {TR_TOOLTIP_NONE, "Nenhum"},
    {TR_TOOLTIP_MINIMAL, "Mínimo"},
    {TR_TOOLTIP_FULL, "Total"},
    {TR_CONFIG_CLEAR_WARNINGS_RIGHTCLICK, "Clicar com botão direito para limpar avisos na visão da cidade"},
    {TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN, "Solicitações de Caesar respeitam ordem de 'Manter'"},
    {TR_CONFIG_ENABLE_MARKET_RANGE, "Habilitar alcance do mercado"},
    ...
    {TR_OVERLAY_HOUSING_TENTS, "Cabanas"},
    {TR_OVERLAY_HOUSING_SHACKS, "Choupanas"},
    {TR_OVERLAY_HOUSING_HOVELS, "Casebres"},
    {TR_OVERLAY_HOUSING_CASAS, "Casas"},
    {TR_OVERLAY_HOUSE_INSULAS, "Insulas"},
    {TR_OVERLAY_HOUSE_VILLAS, "Villas"},
    {TR_OVERLAY_HOUSE_PALACES, "Palácios"},
    {TR_OVERLAY_BY_GROUP, "Por Grupo"},
    {TR_BUTTON_INFO_RETURN_ALL_LEGIONS, "Chamar todas as legiões de volta"},
    {TR_TOOLTIP_OVERLAY_LEVY_PER_TILE, "Denários pagos mensalmente em custos de manutenção por quadrado"},
    {TR_CONFIG_UI_CV_BUILD_MENU_ICONS, "Mostrar ícones de mercadorias no menu de construções"},
    {TR_CONFIG_UI_WT_ENABLE_SNOW_CENTRAL, "Habilitar neve no clima central"},
    {TR_CONFIG_UI_CV_CURSOR_SHADOW, "Habilitar sombra do cursor"},
    {TR_CONFIG_GENERAL_UNLOCK_MOUSE, "Bloquear o cursor do mouse no modo de tela cheia"},
    {TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS, "Moradias sempre se fundem em 2x2"},

#ifdef ENABLE_MULTIPLAYER
    {TR_MP_LOBBY_TITLE, "Lobby Multiplayer"},
    {TR_MP_LOBBY_PLAYERS, "Jogadores"},
    {TR_MP_LOBBY_STATUS, "Status"},
    {TR_MP_LOBBY_PING, "Ping"},
    {TR_MP_LOBBY_READY, "Pronto"},
    {TR_MP_LOBBY_NOT_READY, "Nao pronto"},
    {TR_MP_LOBBY_IN_GAME, "Em jogo"},
    {TR_MP_LOBBY_DISCONNECTED, "Desconectado"},
    {TR_MP_LOBBY_BUTTON_READY, "Pronto"},
    {TR_MP_LOBBY_BUTTON_NOT_READY, "Cancelar pronto"},
    {TR_MP_LOBBY_BUTTON_START, "Iniciar jogo"},
    {TR_MP_LOBBY_BUTTON_LEAVE, "Sair"},
    {TR_MP_LOBBY_WAITING_HOST, "Aguardando o host iniciar..."},
    {TR_MP_LOBBY_NOT_ALL_READY, "Nem todos os jogadores estao prontos"},
    {TR_MP_CONNECT_TITLE, "Multiplayer"},
    {TR_MP_CONNECT_ADDRESS, "Endereco do host:"},
    {TR_MP_CONNECT_BUTTON_CONNECT, "Conectar"},
    {TR_MP_CONNECT_BUTTON_BACK, "Voltar"},
    {TR_MP_CONNECT_LAN_SERVERS, "Servidores LAN"},
    {TR_MP_CONNECT_NO_SERVERS, "Nenhum servidor encontrado"},
    {TR_MP_CONNECT_PLAYERS, "jogadores"},
    {TR_MP_CONNECT_CONNECTING, "Conectando..."},
    {TR_MP_STATUS_TITLE, "Status Multiplayer"},
    {TR_MP_STATUS_CONNECTION, "Conexao:"},
    {TR_MP_STATUS_SYNC, "Sincronia:"},
    {TR_MP_STATUS_TICK, "Tick:"},
    {TR_MP_STATUS_PLAYERS_ONLINE, "Jogadores online"},
    {TR_MP_STATUS_QUALITY_GOOD, "Boa"},
    {TR_MP_STATUS_QUALITY_DEGRADED, "Degradada"},
    {TR_MP_STATUS_QUALITY_POOR, "Ruim"},
    {TR_MP_STATUS_QUALITY_CRITICAL, "Critica"},
    {TR_MP_STATUS_QUALITY_UNKNOWN, "Desconhecida"},
    {TR_MP_STATUS_SYNCED, "Sincronizado"},
    {TR_MP_STATUS_DESYNCED, "Desincronizado"},
    {TR_MP_STATUS_BUTTON_RESYNC, "Ressincronizar"},
    {TR_MP_STATUS_BUTTON_DISCONNECT, "Desconectar"},
    {TR_MP_STATUS_BUTTON_CLOSE, "Fechar"},
    {TR_MP_HOST, "Host"},
    {TR_MP_EMPIRE_PLAYER_CITY, "Cidade do jogador"},
    {TR_MP_EMPIRE_OWNER, "Dono:"},
    {TR_MP_EMPIRE_OFFLINE, "Offline"},
    {TR_MP_EMPIRE_ONLINE, "Online"},
    {TR_MP_EMPIRE_ROUTE_PENDING, "Pendente"},
    {TR_MP_EMPIRE_ROUTE_ACTIVE, "Ativa"},
    {TR_MP_EMPIRE_ROUTE_DISABLED, "Desabilitada"},
    {TR_MP_EMPIRE_ROUTE_OFFLINE, "Offline"},
    {TR_MP_EMPIRE_ROUTE_P2P, "Comercio entre jogadores"},
    {TR_MP_EMPIRE_ROUTE_AI, "Rota comercial"},
    {TR_MP_TRADE_ADVISOR_P2P_ROUTE, "P2P"},
    {TR_MP_TRADE_ADVISOR_AI_ROUTE, "IA"},
    {TR_MP_TRADE_ADVISOR_ROUTE_STATE, "Rota:"},
    {TR_MP_MENU_TITLE, "Multiplayer"},
    {TR_MP_MENU_HOST_LAN, "Hospedar jogo LAN"},
    {TR_MP_MENU_JOIN_LAN, "Entrar em jogo LAN"},
    {TR_MP_MENU_BACK, "Voltar"},
    {TR_MP_MENU_HOST_FAILED, "Falha ao iniciar a sessao host"},
    {TR_MP_MENU_BUTTON_MULTIPLAYER, "Multiplayer"},
    {TR_MP_PAUSE_MENU_MP_STATUS, "Status Multiplayer"},
    {TR_MP_HOST_SETUP_TITLE, "Configurar Jogo Host"},
    {TR_MP_HOST_SETUP_SELECT_SCENARIO, "Selecione um cenario para jogar:"},
    {TR_MP_HOST_SETUP_SELECTED, "Selecionado:"},
    {TR_MP_HOST_SETUP_NO_SCENARIO, "Nenhum cenario selecionado"},
    {TR_MP_HOST_SETUP_BUTTON_SELECT, "Selecionar cenario"},
    {TR_MP_HOST_SETUP_BUTTON_CONTINUE, "Continuar para o lobby"},
    {TR_MP_HOST_SETUP_BUTTON_BACK, "Voltar"},
    {TR_MP_EMPIRE_MY_CITY, "Meu Reino"},
    {TR_MP_EMPIRE_CITY_OF, "Cidade de "},
    {TR_MP_P2P_TRADE_TITLE, "Comercio com "},
    {TR_MP_P2P_TRADE_CREATE_ROUTE, "Criar rota comercial"},
    {TR_MP_P2P_TRADE_DELETE_ROUTE, "Excluir rota"},
    {TR_MP_P2P_TRADE_ENABLE_ROUTE, "Habilitar rota"},
    {TR_MP_P2P_TRADE_DISABLE_ROUTE, "Desabilitar rota"},
    {TR_MP_P2P_TRADE_STATUS, "Status da rota: "},
    {TR_MP_P2P_TRADE_EXPORTS, "Voce exporta (vende):"},
    {TR_MP_P2P_TRADE_IMPORTS, "Voce importa (compra):"},
    {TR_MP_P2P_TRADE_NO_ROUTE, "Nenhuma rota comercial criada"},
    {TR_MP_P2P_TRADE_CITY_OFFLINE, "A cidade esta offline"},
    {TR_MP_P2P_TRADE_THEIR_EXPORTS, "Eles exportam:"},
    {TR_MP_P2P_TRADE_THEIR_IMPORTS, "Eles importam:"},
    {TR_MP_P2P_TRADE_LIMIT, "Limite: "},
    {TR_MP_P2P_TRADE_UNLIMITED, "Sem limite"},
    {TR_MP_P2P_TRADE_ROUTE_FULL, "Maximo de rotas atingido"},
    {TR_MP_P2P_TRADE_SEA_PREF, "Mar"},
    {TR_MP_P2P_TRADE_LAND_PREF, "Terra"},
    {TR_MP_P2P_TRADE_BUTTON_TRADE, "Comerciar"},
    {TR_MP_P2P_TRADE_PRICE, "Preco"},
    {TR_MP_P2P_TRADE_LOADS, " cargas"},
    {TR_MP_P2P_TRADE_NOT_TRADING, "Sem comercio"},
    {TR_MP_P2P_TRADE_ON, "Ligado"},
    {TR_MP_P2P_TRADE_OFF, "Desligado"},
    {TR_MP_P2P_TRADE_YOUR_EXPORTS, "Suas exportacoes:"},
    {TR_MP_P2P_TRADE_PARTNER_EXPORTS, "Exportacoes do parceiro:"},
    {TR_MP_P2P_TRADE_WANTED, "Desejado"},
    {TR_MP_P2P_TRADE_THEY_CAN_EXPORT, "Eles podem exportar:"},
    {TR_MP_P2P_TRADE_THEY_CAN_IMPORT, "Eles podem importar:"},
    {TR_MP_P2P_TRADE_THEY_SELL, "Eles vendem:"},
    {TR_MP_P2P_TRADE_THEY_BUY, "Eles compram:"},
    {TR_MP_P2P_TRADE_NOTHING, "Nada configurado"},
    {TR_MP_P2P_TRADE_MY_TRADE, "Minhas configuracoes"},
    {TR_MP_RESUME_TITLE, "Retomar Jogo Multiplayer"},
    {TR_MP_RESUME_RECONNECTED, "Reconectado"},
    {TR_MP_RESUME_AWAITING, "Aguardando..."},
    {TR_MP_RESUME_WILL_BE_OFFLINE, "Ficara offline"},
    {TR_MP_RESUME_BUTTON_RESUME, "Retomar jogo"},
    {TR_MP_RESUME_BUTTON_LEAVE, "Sair"},
    {TR_MP_RESUME_PLAYERS, "Jogadores"},
    {TR_MP_RESUME_STATUS, "Status"},
    {TR_MP_MENU_RESUME_SAVED, "Retomar jogo salvo"},
    {TR_MP_CONNECT_STATUS_RESUME_RECONNECT, "Retomar: reconexao"},
    {TR_MP_CONNECT_STATUS_LOBBY_OPEN, "Lobby aberto"},
    {TR_MP_CONNECT_STATUS_GAME_RECONNECT, "Jogo: reconexao"},
    {TR_MP_CONNECT_STATUS_GAME_LATE_JOIN, "Jogo: entrada tardia"},
    {TR_MP_CONNECT_STATUS_GAME_CLOSED, "Jogo: fechado"},
    {TR_MP_CONNECT_STATUS_GAME_OPEN, "Jogo: aberto"},
    {TR_MP_CONNECT_TIMEOUT, "Tempo de conexao esgotado"},
    {TR_MP_CONNECT_REJECTED, "Conexao rejeitada"},
    {TR_MP_CONNECT_REJECT_VERSION_MISMATCH, "Versao incompativel"},
    {TR_MP_CONNECT_REJECT_SESSION_FULL, "Sessao lotada"},
    {TR_MP_CONNECT_REJECT_GAME_IN_PROGRESS, "Jogo em andamento"},
    {TR_MP_CONNECT_REJECT_NAME_TAKEN, "Nome ja esta em uso"},
    {TR_MP_CONNECT_REJECT_BANNED, "Acesso bloqueado"},
    {TR_MP_CONNECT_REJECT_NO_RESERVED_SLOTS, "Sem vagas reservadas"},
    {TR_MP_CONNECT_REJECT_LATE_JOIN_BUSY, "Entrada tardia ocupada"},
    {TR_MP_CONNECT_REJECT_RECONNECT_REQUIRED, "Reconexao obrigatoria"},
    {TR_MP_CONNECT_REJECT_SLOT_NOT_FOUND, "Slot nao encontrado"},
    {TR_MP_CONNECT_REJECT_WORLD_MISMATCH, "Mundo divergente"},
    {TR_MP_CONNECT_REJECT_RESUME_GENERATION_MISMATCH, "Resume desatualizado"},
    {TR_MP_CONNECT_REJECT_INTERNAL_ERROR, "Erro interno do host"},
    {TR_MP_LOBBY_AWAITING_RECONNECT, "Aguardando reconexao"},
    {TR_MP_STATUS_LOCAL, "Local"},
    {TR_MP_STATUS_AWAITING, "Aguardando"},
    {TR_MP_RESUME_UNKNOWN, "Desconhecido"},
    {TR_MP_RESUME_SAVE_LABEL, "Salvamento: "},
#endif
};
