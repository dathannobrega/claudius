...
typedef enum {
    ...
    TR_MP_LOBBY_PING,
    TR_MP_LOBBY_READY,
    TR_MP_LOBBY_NOT_READY,
    TR_MP_LOBBY_IN_GAME,
    TR_MP_LOBBY_DISCONNECTED,
    TR_MP_LOBBY_BUTTON_READY,
    TR_MP_LOBBY_BUTTON_NOT_READY,
    TR_MP_LOBBY_BUTTON_START,
    TR_MP_LOBBY_BUTTON_LEAVE,
    TR_MP_LOBBY_WAITING_HOST,
    TR_MP_LOBBY_NOT_ALL_READY,
    TR_MP_CONNECT_TITLE,
    TR_MP_CONNECT_ADDRESS,
    TR_MP_CONNECT_BUTTON_CONNECT,
    TR_MP_CONNECT_BUTTON_BACK,
    TR_MP_CONNECT_LAN_SERVERS,
    TR_MP_CONNECT_NO_SERVERS,
    TR_MP_CONNECT_PLAYERS,
    TR_MP_CONNECT_CONNECTING,
    TR_MP_STATUS_TITLE,
    TR_MP_STATUS_CONNECTION,
    TR_MP_STATUS_SYNC,
    TR_MP_STATUS_TICK,
    TR_MP_STATUS_PLAYERS_ONLINE,
    TR_MP_STATUS_QUALITY_GOOD,
    TR_MP_STATUS_QUALITY_DEGRADED,
    TR_MP_STATUS_QUALITY_POOR,
    TR_MP_STATUS_QUALITY_CRITICAL,
    TR_MP_STATUS_QUALITY_UNKNOWN,
    TR_MP_STATUS_SYNCED,
    TR_MP_STATUS_DESYNCED,
    TR_MP_STATUS_BUTTON_RESYNC,
    TR_MP_STATUS_BUTTON_DISCONNECT,
    TR_MP_STATUS_BUTTON_CLOSE,
    TR_MP_HOST,
    /* Phase 5: Empire window and trade advisor multiplayer UI */
    TR_MP_EMPIRE_PLAYER_CITY,
    TR_MP_EMPIRE_OWNER,
    TR_MP_EMPIRE_OFFLINE,
    TR_MP_EMPIRE_ONLINE,
    TR_MP_EMPIRE_ROUTE_PENDING,
    TR_MP_EMPIRE_ROUTE_ACTIVE,
    TR_MP_EMPIRE_ROUTE_DISABLED,
    TR_MP_EMPIRE_ROUTE_OFFLINE,
    TR_MP_EMPIRE_ROUTE_P2P,
    TR_MP_EMPIRE_ROUTE_AI,
    TR_MP_TRADE_ADVISOR_P2P_ROUTE,
    TR_MP_TRADE_ADVISOR_AI_ROUTE,
    TR_MP_TRADE_ADVISOR_ROUTE_STATE,
    TR_MP_MENU_TITLE,
    TR_MP_MENU_HOST_LAN,
    TR_MP_MENU_JOIN_LAN,
    TR_MP_MENU_BACK,
    TR_MP_MENU_HOST_FAILED,
    TR_MP_MENU_BUTTON_MULTIPLAYER,
    TR_MP_PAUSE_MENU_MP_STATUS,
    TR_MP_HOST_SETUP_TITLE,
    TR_MP_HOST_SETUP_SELECT_SCENARIO,
    TR_MP_HOST_SETUP_SELECTED,
    TR_MP_HOST_SETUP_NO_SCENARIO,
    TR_MP_HOST_SETUP_BUTTON_SELECT,
    TR_MP_HOST_SETUP_BUTTON_CONTINUE,
    TR_MP_HOST_SETUP_BUTTON_BACK,
    TR_MP_EMPIRE_MY_CITY,
    TR_MP_EMPIRE_CITY_OF,
    TR_MP_P2P_TRADE_TITLE,
    TR_MP_P2P_TRADE_CREATE_ROUTE,
    TR_MP_P2P_TRADE_DELETE_ROUTE,
    TR_MP_P2P_TRADE_ENABLE_ROUTE,
    TR_MP_P2P_TRADE_DISABLE_ROUTE,
    TR_MP_P2P_TRADE_STATUS,
    TR_MP_P2P_TRADE_EXPORTS,
    TR_MP_P2P_TRADE_IMPORTS,
    TR_MP_P2P_TRADE_NO_ROUTE,
    TR_MP_P2P_TRADE_CITY_OFFLINE,
    TR_MP_P2P_TRADE_THEIR_EXPORTS,
    TR_MP_P2P_TRADE_THEIR_IMPORTS,
    TR_MP_P2P_TRADE_LIMIT,
    TR_MP_P2P_TRADE_UNLIMITED,
    TR_MP_P2P_TRADE_ROUTE_FULL,
    TR_MP_P2P_TRADE_SEA_PREF,
    TR_MP_P2P_TRADE_LAND_PREF,
    TR_MP_P2P_TRADE_BUTTON_TRADE,
    TR_MP_P2P_TRADE_PRICE,
    TR_MP_P2P_TRADE_LOADS,
    TR_MP_P2P_TRADE_NOT_TRADING,
    TR_MP_P2P_TRADE_ON,
    TR_MP_P2P_TRADE_OFF,
    TR_MP_P2P_TRADE_YOUR_EXPORTS,
    TR_MP_P2P_TRADE_PARTNER_EXPORTS,
    TR_MP_P2P_TRADE_WANTED,
    TR_MP_P2P_TRADE_THEY_CAN_EXPORT,
    TR_MP_P2P_TRADE_THEY_CAN_IMPORT,
    TR_MP_P2P_TRADE_THEY_SELL,
    TR_MP_P2P_TRADE_THEY_BUY,
    TR_MP_P2P_TRADE_NOTHING,
    TR_MP_P2P_TRADE_MY_TRADE,
    TR_MP_RESUME_TITLE,
    TR_MP_RESUME_RECONNECTED,
    TR_MP_RESUME_AWAITING,
    TR_MP_RESUME_WILL_BE_OFFLINE,
    TR_MP_RESUME_BUTTON_RESUME,
    TR_MP_RESUME_BUTTON_LEAVE,
    TR_MP_RESUME_PLAYERS,
    TR_MP_RESUME_STATUS,
    TR_MP_MENU_RESUME_SAVED,
    TR_MP_CONNECT_STATUS_RESUME_RECONNECT,
    TR_MP_CONNECT_STATUS_LOBBY_OPEN,
    TR_MP_CONNECT_STATUS_GAME_RECONNECT,
    TR_MP_CONNECT_STATUS_GAME_LATE_JOIN,
    TR_MP_CONNECT_STATUS_GAME_CLOSED,
    TR_MP_CONNECT_STATUS_GAME_OPEN,
    TR_MP_CONNECT_TIMEOUT,
    TR_MP_CONNECT_REJECTED,
    TR_MP_CONNECT_REJECT_VERSION_MISMATCH,
    TR_MP_CONNECT_REJECT_SESSION_FULL,
    TR_MP_CONNECT_REJECT_GAME_IN_PROGRESS,
    TR_MP_CONNECT_REJECT_NAME_TAKEN,
    TR_MP_CONNECT_REJECT_BANNED,
    TR_MP_CONNECT_REJECT_NO_RESERVED_SLOTS,
    TR_MP_CONNECT_REJECT_LATE_JOIN_BUSY,
    TR_MP_CONNECT_REJECT_RECONNECT_REQUIRED,
    TR_MP_CONNECT_REJECT_SLOT_NOT_FOUND,
    TR_MP_CONNECT_REJECT_WORLD_MISMATCH,
    TR_MP_CONNECT_REJECT_RESUME_GENERATION_MISMATCH,
    TR_MP_CONNECT_REJECT_INTERNAL_ERROR,
    TR_MP_LOBBY_AWAITING_RECONNECT,
    TR_MP_STATUS_LOCAL,
    TR_MP_STATUS_AWAITING,
    TR_MP_RESUME_UNKNOWN,
    TR_MP_RESUME_SAVE_LABEL,
#endif
    TRANSLATION_MAX_KEY
} translation_key;
